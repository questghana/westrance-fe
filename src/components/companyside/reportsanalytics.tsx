...
export const columns = (): ColumnDef<Data>[] => [
  ...
  },
  {
    ...
    cell: ({ row }) => {
      const totalAmount = row.original.employeeAmountPackage || row.original.hospitalEmployeeAmountPackage;
...
const Reportsanalytics: React.FC<{ className?: string }> = ({ className }) => {
  ...
  const getCompanyReportAnalyticsStats = async () => {
    try {
      setLoading(true)
      const response = await axios.get("/company/reports-analytics-stats")
  ...
  useEffect(() => {
    getCompanyReportAnalyticsStats()
  }, [])
  ...
  const stats: Stat[] = [
    {
      ...
      icon: coveredemp,
      count: loading ? <Loader className="animate-spin" /> : statsData?.totalEmployeesCovered || "0",
      bgColor: "#e9eefd",
      bgIconColor: "#daeefc",
      iconColor: "#6da4de",
    },
    {
      ...
      icon: medicalcovered,
      count: loading ? <Loader className="animate-spin" /> : statsData?.totalMedicalCovered || "0",
      bgColor: "#f5edfd",
      bgIconColor: "#e8dcfc",
      iconColor: "#715bc0",
    },
    {
      ...
      icon: benefit,
      count: loading ? <Loader className="animate-spin" /> : `₵ ${statsData?.totalBenefitsUtilized}` || "₵ 0",
      bgColor: "#e7fcf7",
      bgIconColor: "#d2f3eb",
      iconColor: "#499581",
    },
    {
      ...
      count: loading ? <Loader className="animate-spin" /> : statsData?.averageUtilizationRate || "0%",
      bgColor: "#fff7ec",
      bgIconColor: "#fff2e0",
      iconColor: "#f0ac5c",
    },

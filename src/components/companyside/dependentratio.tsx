...
const chartData = [
    { name: "Total \n Employees", desktop: 100, fill: '#0083E6' },
    { name: "Assign \n Employees", desktop: 60, fill: '#78B7ED' },
    { name: "Total \n Dependents", desktop: 40, fill: '#0083E6' },
]
